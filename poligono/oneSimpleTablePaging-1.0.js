		...
		'oneSimpleTablePagination': function(userConfigurations) {
			...
			return this.each(function() {
				...
				function createPaginationElements() {
					var paginationHTML = "";
					paginationHTML += "<div id='tablePagination' style='text-align: left; padding-left:80px;margin-top:-30px;'>";
